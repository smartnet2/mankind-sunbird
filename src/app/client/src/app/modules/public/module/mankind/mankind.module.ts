...
import { MankindComponent, AboutusComponent, DashboardMR, DashboardRegionalSalesManager, Blog } from './components';
...
@NgModule({
  ...
  declarations: [MankindComponent, AboutusComponent, DashboardMR, DashboardRegionalSalesManager, Blog, EmailInputComponent],
